...
ALTER TABLE `REPOSITORIES`
  ADD FOREIGN KEY (`GITHUB_ID`)
  REFERENCES `GITHUB_USERS` (`GITHUB_ID`);

ALTER TABLE `ANALYSIS_WCAG_RESULTS`
  ADD FOREIGN KEY (`REPOSITORY_ID`)
  REFERENCES `REPOSITORIES` (`REPOSITORY_ID`);

ALTER TABLE `ANALYSIS_WCAG_RESULTS`
  ADD FOREIGN KEY (`WCAG_ITEM_ID`)
  REFERENCES `WCAG_ITEMS` (`WCAG_ITEM_ID`);

ALTER TABLE `ANALYSIS_ISSUES`
  ADD FOREIGN KEY (`ANALYSIS_WCAG_RESULT_ID`)
  REFERENCES `ANALYSIS_WCAG_RESULTS` (`ANALYSIS_WCAG_RESULT_ID`)
  ON DELETE CASCADE;

ALTER TABLE `ANALYSIS_ISSUES_LOCATIONS`
  ADD FOREIGN KEY (`ANALYSIS_ISSUE_ID`)
  REFERENCES `ANALYSIS_ISSUES` (`ANALYSIS_ISSUE_ID`)
  ON DELETE CASCADE;
